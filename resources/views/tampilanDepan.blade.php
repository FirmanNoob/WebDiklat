    ...
    <main>
        ...
        <section class="slick-slideshow">
            <div class="slick-custom">
                <img src="{{ asset('depan/images/slideshow/medium-shot-business-women-high-five.jpeg') }}" class="img-fluid" alt="">
            ...
            <div class="slick-custom">
                <img src="{{ asset('depan/images/slideshow/team-meeting-renewable-energy-project.jpeg') }}" class="img-fluid" alt="">
            ...
            <div class="slick-custom">
                <img src="{{ asset('depan/images/slideshow/two-business-partners-working-together-office-computer.jpeg') }}" class="img-fluid" alt="">
